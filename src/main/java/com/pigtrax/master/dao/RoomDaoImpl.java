...
public class RoomDaoImpl implements RoomDao {
	...
	public List<Room> getRoomList(final int generatedBarnId) {
		String query = "SELECT \"id\",\"roomId\", \"location\",\"id_Barn\", \"isActive\",\"id_roomPosition\" from pigtrax.\"Room\" where \"id_Barn\" = ? order by \"id\" desc ";
	...
	{
		String query = "SELECT \"id\",\"roomId\", \"location\",\"id_Barn\", \"isActive\", \"id_roomPosition\" from pigtrax.\"Room\" where \"id\" = ?";
	...
	public int insertRoomRecord(final Room room) throws SQLException {
		String query = "INSERT INTO pigtrax.\"Room\"(  \"roomId\", \"id_Barn\", location, "
				+ " \"isActive\", \"lastUpdated\",\"userUpdated\", \"id_roomPosition\")"
				+ "VALUES ( ?, ?, ?, ?, ?, ?, ?)";
	...
	public int updateRoomRecord(final Room room) throws SQLException {
		String query = "update pigtrax.\"Room\" SET location=?, \"lastUpdated\"=?,"
				+ " \"userUpdated\"=?, \"id_roomPosition\"=?  WHERE \"roomId\"=?";
		return this.jdbcTemplate.update(query, new PreparedStatementSetter() {
			@Override
			public void setValues(PreparedStatement ps) throws SQLException {
