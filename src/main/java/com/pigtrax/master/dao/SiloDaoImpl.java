...
public class SiloDaoImpl implements SiloDao {
	...
	public List<Silo> getSiloList(final int generatedBarnId) {
		String query = "SELECT \"id\",\"siloId\", \"location\",\"id_Barn\", \"isActive\" from pigtrax.\"Silo\" where \"id_Barn\" = ? order by \"id\" desc ";
	...
	{
		String query = "SELECT \"id\",\"siloId\", \"location\",\"id_Barn\", \"isActive\" from pigtrax.\"Silo\" where \"id\" = ?";
	...
	private static final class SiloMapper implements RowMapper<Silo> {
		public Silo mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			silo.setActive(rs.getBoolean("isActive"));
			return silo;
		}
	}
