...
public class PremisesDaoImpl implements PremisesDao{
	...
	public List<Premises> getPremisesList(final int generatedCompanyId) {
		String query = "SELECT \"id\",\"permiseId\", \"id_Company\", \"name\", \"address\", \"city\", \"state\", \"zipcode\", \"isActive\",\"gpsLatittude\",\"gpsLongitude\",\"id_PremiseType\" "
	...
	public int insertPremisesRecord(final Premises premises) throws SQLException {
		String query = "INSERT INTO pigtrax.\"Premise\"(  \"permiseId\", \"id_Company\", name, address, city, state, zipcode, "
				 +" \"isActive\", \"lastUpdated\",\"userUpdated\",\"gpsLatittude\",\"gpsLongitude\",\"id_PremiseType\")"+
				 "VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
	...
	public int updatePremisesRecord(final Premises premises) throws SQLException {
		String query = "update pigtrax.\"Premise\" SET name=?, address=?, city =?, state =?, zipcode=?, \"lastUpdated\"=?, \"userUpdated\"=?,\"gpsLatittude\"=?, \"gpsLongitude\"=?,\"id_PremiseType\"=?"
				+ "  WHERE \"permiseId\"=?";
		return this.jdbcTemplate.update(query, new PreparedStatementSetter() {
			@Override
			public void setValues(PreparedStatement ps) throws SQLException {
				...
				ps.setString(11, premises.getPermiseId().toUpperCase());
			}
		});
	}
