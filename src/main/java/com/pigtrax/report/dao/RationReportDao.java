...
public class RationReportDao {
	...
	public List<RationReportBean> getRationReportList(final Integer premiseId, final Date startDate, final Date endDate, final Integer groupId)
	{
		...
		String qry = "SELECT MR.\"rationValue\" as \"rationId\", R.\"actualTons\" as \"actualTonsUsed\", R.\"tons\" as \"targetTonsUsed\", (R.\"actualTons\" - R.\"tons\")/R.\"tons\" as \"deviationTonsUsed\", "
				...
				+" LEFT JOIN ( "
				+"  SELECT CT.\"id_Premise\", CAST(coalesce(CT.\"targetValue\", '0') AS decimal) as \"kg/day\", 'Kg/Day' as ind from pigtrax.\"CompanyTarget\"  CT "
				...
				+" LEFT JOIN ( "
				+" select CT.\"id_Premise\",  CAST(coalesce(CT.\"targetValue\", '0') AS decimal) as \"tons\", 'tonsUsed' as ind from pigtrax.\"CompanyTarget\"  CT "
				...
				+" LEFT JOIN ( "
				+"   select CT.\"id_Premise\",  CAST(coalesce(CT.\"targetValue\", '0') AS decimal) as \"feedCostTarget\", 'feedCostTarget' as ind from pigtrax.\"CompanyTarget\"  CT "
