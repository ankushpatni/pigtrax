...
public class GroupReportDao {
	...
	String query = 			" Select T.\"groupId\", T.\"Event Date\", T.\"Event Name\", T.\"Data\",T.\"RemovalType\",T.\"mortalityReason\", T.\"Ticketnumber\",T.\"salesTypes\",T.\"phaseChange\", T.\"AdditionalData\" from ( "
			...
			+" 'Pigs : '|| GED.\"numberOfPigs\" || ' :: Weight :' || GED.\"weightInKgs\"  as \"Data\", "
			...
			+" '' as \"phaseChange\", "
			+" case when GED.\"remarks\" = 'Transferred' THEN   ' :: Transfered To : ' || coalesce(GEF.\"groupId\",'') || ' :: From Premise : '||PRE.\"name\"||' :: To Premise : '||PRE2.\"name\"||' :: To Room :'||ROOM2.\"roomId\" "
			+" ELSE case when GED.\"remarks\" = 'Received' THEN ' :: Transfered From : ' || coalesce(GEF.\"groupId\",'') || ' :: From Premise : '||PRE2.\"name\"||' :: To Premise : '||PRE.\"name\"||' :: From Room :'||ROOM2.\"roomId\" END END as \"AdditionalData\" "
			...
			+" UNION ALL "
			+" ( select  2 as row,  RES.\"id_RemovalEvent\", GE.\"groupId\",  RES.\"removalDateTime\" as \"Event Date\", 'Group Transfer' as \"Event Name\", "
