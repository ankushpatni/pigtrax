...
public List<SaleReportBean> getSaleList(final int premisesId, final int barnId, final int groupId, final Date start, final Date end, String ticketNumber) {
		
		String query = "select P.\"name\",GE.\"groupId\", RES.\"salesDateTime\", RES.\"salesTypes\",RES.\"numberOfPigs\", RES.\"soldTo\", "
