...
public class RefDataDaoImpl implements RefDataDao {
	...
	public List<RefDataTranslationDto> getTargetTypes() {
		String query = "SELECT \"fieldValue\", \"fieldLanguage\", \"id_TargetType\" FROM pigtraxrefdata.\"TargetTypeTranslation\" order by \"id_TargetType\", \"fieldLanguage\", \"fieldValue\"; ";
		return jdbcTemplate.query(query, new CacheRefDataRowMaper());
	}
	...
	@Override
	public List<RefDataTranslationDto> getSaleReasons() {
	...
	@Override
	public List<RefDataTranslationDto> getSaleTypes() {
	...
	@Override
	public List<RefDataTranslationDto> getMarketTypes() {
		String query = "SELECT \"fieldValue\", \"fieldLanguage\", \"id_MarketType\" FROM pigtraxrefdata.\"MarketTypeTranslation\" order by \"fieldLanguage\", \"fieldValue\"; ";
		return jdbcTemplate.query(query, new CacheRefDataRowMaper());
	}
