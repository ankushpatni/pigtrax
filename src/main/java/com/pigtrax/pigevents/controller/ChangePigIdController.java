...
@Controller
public class ChangePigIdController {
	
	 private static final Logger logger = Logger.getLogger(ChangePigIdController.class);
	 ...
	 CompanyService companyService;
	   ...
	   public String loadEntryEnventPage(HttpServletRequest request, Model model)  
	   {
		   ...
		   model.addAttribute("contentUrl","ChangePigId.jsp");
		   return "template";
	   }
	   
	   
	   @RequestMapping("/toChangeId")
