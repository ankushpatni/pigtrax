...
@Controller
public class PigletEventController {
	
	 private static final Logger logger = Logger.getLogger(PigletEventController.class);
	 
	 @Autowired
	 CompanyService companyService;
	
	   @RequestMapping(value="/pigletEvent", method=RequestMethod.POST)
	   public String loadPregnancyEvent(HttpServletRequest request, Model model)  
	   {
		   ...
		   model.addAttribute("contentUrl","PigletEvent.jsp");
		   return "template";
	   }
	   
	   
	   @RequestMapping("/loadPigletEvent")
