...
public class TargetController {
	 ...
	 CompanyService companyService;
	   ...
	   @RequestMapping(value="/companyTarget", method=RequestMethod.POST)
	   public String loadTargetPage(HttpServletRequest request, Model model)  
	   {
		   ...
		   model.addAttribute("contentUrl","CompanyTarget.jsp");
		   return "template";
	   }
	   
	   
	   @RequestMapping("/goToCompanyTarget")
