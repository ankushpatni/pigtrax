...
public class FarrowEventDaoImpl implements FarrowEventDao {
	...
	public int addFarrowEventDetails(final FarrowEvent farrowEvent)
		...
		final String Qry = "insert into pigtrax.\"FarrowEvent\"(\"farrowDateTime\", \"id_Pen\", \"liveBorns\", "
				...
				+ "\"id_PigInfo\", \"id_PregnancyEvent\",\"teats\",\"id_PigletCondition\", \"weakBorns\",\"id_Premise\",\"id_BreedingEvent\" ) "
		...
		jdbcTemplate.update(
	    	    new PreparedStatementCreator() {
	    	        public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
	    				...
	    				ps.setObject(17,  farrowEvent.getTeats(), java.sql.Types.INTEGER);
	    				...
	    				if(farrowEvent.getPremiseId() != null && farrowEvent.getPremiseId() != 0){
	    					ps.setInt(20, farrowEvent.getPremiseId());
	    				}
	    				else{
	    					ps.setNull(20, java.sql.Types.INTEGER);
	    				}
	    				if( farrowEvent.getBreedingEventId() != null){
	    					ps.setInt(21, farrowEvent.getBreedingEventId());
	    				}
	    				else{
   ...
   public FarrowEvent getFarrowEvent(final Integer farrowEventId) { 
	   ...
	   String qry = "select FE.\"id\", FE.\"farrowDateTime\", FE.\"id_Pen\", "
		   		...
		   		+ "FE.\"teats\", FE.\"id_PigletCondition\", FE.\"weakBorns\", FE.\"litterId\",FE.\"id_Premise\", FE.\"id_BreedingEvent\" "
  ...
  private List<FarrowEvent> getFarrowEventsByTattoo(final String tattoo, final Integer companyId, final Integer premiseId) throws SQLException{
	...
	public int updateFarrowEventDetails(final FarrowEvent farrowEvent)
		...
		String Qry = "update pigtrax.\"FarrowEvent\" set  \"id_Pen\" = ?, \"farrowDateTime\"= ?, \"liveBorns\"= ?"
				...
				+ "\"teats\" = ?,\"id_PigletCondition\"=?, \"weakBorns\"=?,\"id_Premise\"=?, \"id_BreedingEvent\"=? where \"id\" = ? ";
		...
		return this.jdbcTemplate.update(Qry, new PreparedStatementSetter() {
			...
			public void setValues(PreparedStatement ps) throws SQLException {
				...
				if(farrowEvent.getId() != null){
					ps.setInt(22, farrowEvent.getId());
				}
				else{
   ...
   private static final class FarrowEventMapper implements RowMapper<FarrowEvent> {
		public FarrowEvent mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			farrowEvent.setBreedingEventId(rs.getInt("id_BreedingEvent"));
			return farrowEvent;
		}
	} 
   ...
   @Override
	public boolean checkFarrowEventByBreedingEvent(final Integer breedingEventId) { 
		String sql = "select count(FE.\"id\") from pigtrax.\"FarrowEvent\" FE where \"id_BreedingEvent\" = ? ";
