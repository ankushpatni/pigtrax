pigTrax.controller('trackingAggregatorController', function($scope, $location,$http, $window,$modal, restServices) {	
	$scope.companyId = 0;
	var localCompany ;
	...
	$scope.redirectMortality = function()
	{
		window.location = 'reportPigletMortality';
	}
	$scope.redirectGestation = function()
	{
		window.location = 'gestationReport';
	}
	$scope.redirectGroupStatus = function()
	{
		window.location = 'groupStatusReport';
	}
	$scope.redirectRation = function()
	{
		window.location = 'rationReport';
	}
