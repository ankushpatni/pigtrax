pigTrax.controller('LactationLengthController', function($scope, $http, $window,$modal, restServices) {	
	$scope.companyId = 0;
	$scope.startDate;
	$scope.endDate;
    ...
    $scope.generateLactationLengthReport = function()
    {	
		...
		document.forms['generateLactationLengthReportForm'].submit();
