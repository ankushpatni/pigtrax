...
<div class="cl-mcont" id="sowReposrtGeneraterControllerId" ng-controller="sowReportController" ng-init="loadPremises('${CompanyId}','${REPORT_NO_DATA}')" class="container-fluid">
<div class="row">
