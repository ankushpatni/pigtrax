...
<div class="modal-body form">
    <input class="form-control" type="hidden" name="location" ng-model="add.location" />
			...
			<div class="form-group">
                 ...
                 <select class="form-control" name="year" ng-model="add.year" >
	    ...
	    <select class="form-control"  name="waterTypeId" ng-model="add.waterTypeId" >
         ...
         <div class="modal-footer">
            ...
            <button class="btn btn-success btn-flat md-close"  ng-click="addBarn()" ng-hide="edit"><spring:message code="label.premise.add" text="Add" /></button>
			<button class="btn btn-success btn-flat md-close"  ng-click="addBarn()" ng-show="edit"><spring:message code="label.premise.save" text="Save" /></button>
