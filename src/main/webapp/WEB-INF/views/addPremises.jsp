...
<form name="premisesAddForm" novalidate angular-validator>
	<div class="modal-body form">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" placeholder="<spring:message code='label.company.country' text='Country' />" name="state" ng-model="add.state" maxlength="30" required-message="'<spring:message code='label.company.countryRequired' text='Country is required' />'" />
...
<!-- 				       ng-change="changeCity()"  ng-options="state.value as state.name for state in country"></select> -->
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" placeholder="<spring:message code='label.premise.city' text='City' />" name="city" ng-model="add.city" maxlength="30" required-message="'<spring:message code='label.premise.cityRequired' text='City is required' />'" />
