...
<div class="row">
		...
		<div class="col-sm-6 col-md-6">
			<div class="block-flat">
				<form method="POST" novalidate angular-validator  action="generateActionListReport" name="generateReportActionList">
					<div class="head">
						...
						<button type="button" value="report" ng-click="generateActionListReport()">
