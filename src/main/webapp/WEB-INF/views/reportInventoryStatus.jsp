...
<div class="cl-mcont" id="InventoryStatusReportControllerId" ng-controller="InventoryStatusReportController" ng-init="loadPremises('${CompanyId}','${REPORT_NO_DATA}')" class="container-fluid">
<div class="row">
		<div class="col-sm-3 col-md-3"></div>
		<div class="col-sm-6 col-md-6">
			<div class="block-flat">
				<form method="POST" novalidate angular-validator  action="generateInventoryStatusReport" name="generateInventoryStatusReportForm">
					<div class="head">
						...
						<button type="button" value="report" ng-click="generateInventoryStatusReport()">
