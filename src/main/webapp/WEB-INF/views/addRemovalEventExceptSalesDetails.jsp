...
<div class="page-head">
 ...
 <div class="cl-mcont" ng-controller="RemovalExceptSalesController" ng-init="setCompanyId('${CompanyId}','${removalId}','${removalGeneratedId}','${removalExceptSalesId}')">
        <div class="row" >
		  <div class="col-sm-3 col-md-3"></div>
            <div class="col-sm-6 col-md-6">
              <div class="block-flat">
                ...
                <div class="content">
                  <form name="removalExceptSales" novalidate angular-validator my-reset>
				   ...
				   <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div data-min-view="2" data-date-format="yyyy-mm-dd" class="input-group date datetime col-md-5 col-xs-7"  >
                          <input size="16" type="date" id="removalDateTime" name="removalDateTime" ng-model="removalExceptSales.removalDateTime" readonly="" class="form-control" format-date required-message="'<spring:message code='label.piginfo.removalExceptSales.removalDateTime.requiredMessage' text='Removal Except Sales Date Time is required' />'"/><span class="input-group-addon btn btn-primary"><span class="glyphicon glyphicon-th"></span></span>
						</div>
                    </div>
					<div>
                    ...
                    <div class="form-group">
                      <label><spring:message code='label.piginfo.removalExceptSales.groupEventId'  text='Group Event'/></label>
                       <select ng-hide="(removalExceptSales.id != null && removalExceptSales.id > 0) || entryEventSuccessMessage" class="form-control"  name="groupEventId" id="groupEventId" ng-model="removalExceptSales.groupEventId"   
                         ng-options="k as v for (k, v) in groupEventList"> </select>
                         <label ng-show="(removalExceptSales.id != null && removalExceptSales.id > 0) || entryEventSuccessMessage"> :  {{groupEventList[removalExceptSales.removalTypeId]}}</label>                       
                    </div>
                    <div class="form-group">
                      <label><spring:message code='label.piginfo.removalExceptSales.barnId'  text='Barn'/></label>
                       <select ng-hide="(removalEvent.id != null && removalEvent.id > 0) || entryEventSuccessMessage" class="form-control" name="barnId" id="barnId" ng-model="removalExceptSales.barnId"   
                         ng-options="k as v for (k, v) in barnList"> </select>
                         <label ng-show="(removalExceptSales.id != null && removalExceptSales.id > 0) || entryEventSuccessMessage"> :  {{barnList[removalExceptSales.barnId]}}</label>                       
                    </div>
                    <div class="form-group">
                  	...
                  	<button class="btn btn-primary" ng-click="addRemovalExceptSales()" type="submit" ng-hide="(removalEvent.id != null && removalEvent.id > 0) || entryEventSuccessMessage"><spring:message code='label.piginfo.groupEventform.add'  text='Add'/></button>
					<button class="btn btn-primary" ng-click="addRemovalExceptSales()" type="submit" ng-show="(removalEvent.id != null && removalEvent.id > 0) || entryEventSuccessMessage"><spring:message code='label.piginfo.groupEventform.edit'  text='Edit'/></button>
