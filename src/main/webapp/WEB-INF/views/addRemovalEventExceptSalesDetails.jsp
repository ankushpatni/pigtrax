                ...
                <div class="content">
				  ...
				  <!-- <div class="form-group">
				   ...
				   <div class="form-group">
                      ...
                      <input type="text" ng-show="selectGroup==='group'" ng-readonly="selectGroup==='group' && removalTypeId == 9" ng-model="removalExceptSales.numberOfPigs" id="numberOfPigs" name="numberOfPigs"  class="form-control" maxlength="30" placeholder="<spring:message code='label.piginfo.removalExceptSales.numberOfPigs.placeholder'  text='Enter Number Of Pigs'/>" 
                   ...
                   <div>
					...
					<div>
                     ...
                     <input class="form-control" type="text" ng-readonly="selectGroup==='group' && removalTypeId == 9"  placeholder="<spring:message code='label.piginfo.removalExceptSales.weightInKgs.placeHolder' text='Enter Weight' />" 
