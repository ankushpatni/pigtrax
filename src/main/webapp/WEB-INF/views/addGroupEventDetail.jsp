 ...
 <div class="cl-mcont" ng-controller="AddGroupEventDetailController" ng-init="setCompanyId('${companyId}','${groupId}','${groupEventId}','${groupGeneratedId}')">
        ...
        <div class="row" >
		  <div class="col-sm-3 col-md-3"></div>
			...
			<button class="btn btn-primary btn-flat md-close"  ng-click="addGroupEventDetail()" ng-hide="edit"><spring:message code="label.premise.add" text="Add" /></button>
			<button class="btn btn-primary btn-flat md-close"  ng-click="addGroupEventDetail()" ng-show="edit"><spring:message code="label.premise.edit" text="Edit" /></button>
