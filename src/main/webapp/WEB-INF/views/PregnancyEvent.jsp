 ...
 <div class="row">
		   ...
		   <form name="breedingEventSearchForm" >
			 ...
			 <div class="options">
              <div class="form-group">
                <label class="radio-inline">
                  <input type="radio" name="rad1" id="rad1" class=" pregnancyevent" value="pigId" ng-model="selectGroup"> <spring:message code='label.piginfo.breedingeventform.search.pigid.option'  text='Pig Id'/>
                </label>
                <label class="radio-inline">
                  <input type="radio" name="rad1"  id="rad2" class=" pregnancyevent" value="tattoo" ng-model="selectGroup"> <spring:message code='label.piginfo.breedingeventform.search.tattoo.option'  text='Tattoo'/> 
                </label>				
              </div>
            </div>
			...
			<div  class="form-group" ng-show="selectGroup==='pigId'">
				  ...
				  <button type="button" class="btn btn-primary active btn-group pull-right" ng-enter="getPregnancyEventInformation()" ng-click="getPregnancyEventInformation()"><i class="fa fa-search"></i></button>
					 ...
					 <select  class="form-control"  name="search" ng-model="searchText" style="width:87%">
								...
								<option ng-repeat="pigInfo in pigInfoListSearch" value="{{pigInfo.pigId}}" ng-value="pigInfo.pigId" ng-selected="searchText == premise.pigId">{{pigInfo.pigId}}</option>
								</select>
			</div>
