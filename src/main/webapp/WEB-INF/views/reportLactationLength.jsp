...
<!-- ======== @Region: #content ======== -->
<div class="page-head">
	<h2><spring:message	code='label.generateLactationLengthReport.heading'
								text='Generate Lactation Length Report' /></h2>
</div>
<div class="cl-mcont" id="LactationLengthControllerId" ng-controller="LactationLengthController" ng-init="loadPremises('${CompanyId}','${REPORT_NO_DATA}')" class="container-fluid">
<div class="row">
		<div class="col-sm-3 col-md-3"></div>
		<div class="col-sm-6 col-md-6">
			<div class="block-flat">
				<form method="POST" novalidate angular-validator  action="generateLactationLengthReport" name="generateLactationLengthReportForm">
					<div class="head">
						<h3 style="color:green">${token}</h3>
						<h3>
							<spring:message
								code='label.generateLactationLengthReport.heading'
								text='Generate Lactation Length Report' />
						</h3>
						...
						<button type="button" value="report" ng-click="generateLactationLengthReport()">
