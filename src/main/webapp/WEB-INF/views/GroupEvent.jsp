              ...
              <div class="block-flat">
                ...
                <div class="content">
				  ...
				  <div class="form-group">
					...
					<button class="btn btn-success" data-toggle="modal" ng-click="transferToGroupInit(groupEvent.phaseOfProductionTypeId)" data-target="#transferToGroupModal"   type="submit" ng-confirm-click="<spring:message code='label.piginfo.groupEventform.transferToFinish.confirmmessage'  text='Are you sure you want to transfer?'/>" ng-show="(groupEvent.id != null && groupEvent.id > 0 && (groupEvent.phaseOfProductionTypeId == 3) && groupEvent.active && groupEvent.currentInventory>0) "><spring:message code='label.piginfo.groupEventform.transferToPhase1'  text='Transfer'/></button>
					<button class="btn btn-success" data-toggle="modal" ng-click="transferToGroupInit(4)" data-target="#transferToGroupModal"  type="submit" ng-confirm-click="<spring:message code='label.piginfo.groupEventform.transferToGDU.confirmmessage'  text='Are you sure you want to transfer to GDU?'/>" ng-show="(groupEvent.id != null && groupEvent.id > 0 && groupEvent.phaseOfProductionTypeId != 4 && groupEvent.active && groupEvent.currentInventory>0) "><spring:message code='label.piginfo.groupEventform.transferToGDU'  text='Transfer to GDU'/></button>
