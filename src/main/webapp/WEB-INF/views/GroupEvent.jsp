...
<div class="page-head">
 ...
 <div class="cl-mcont" ng-controller="GroupEventController" ng-init="loadPage(${CompanyId})">
 <div class="row">
		  ...
		  <form name="groupEventSearchResultForm"  ng-if="groupEventList != null && groupEventList.length != 0" >
 		     <div class="head">
            <h3> <spring:message code='label.piginfo.groupEventForm.searchresults.heading'  text='Group Events'/></h3>
             <table>
				<thead>
                     <tr>
                 ...
                 <tbody>
                   <tr ng-repeat="groupEventDto in groupEventList">
              ...
              <div class="block-flat">
                ...
                <div class="content">
				  ...
				  <div class="form-group">
                    ...
                    <%--  <input type="text" ng-model="groupEvent.groupId" id="groupId" name="groupId"  class="form-control" maxlength="30" placeholder="<spring:message code='label.piginfo.pregnancyeventform.pigInfoId.placeholder'  text='Enter Piginfo Id'/>" 
                   ...
                   --%> 
                    <input type="text" ng-model="groupEvent.groupId" id="groupId" name="groupId"  class="form-control" maxlength="30" placeholder="<spring:message code='label.piginfo.groupEventForm.groupId.placeholder'  text='Enter Group Id'/>" 
